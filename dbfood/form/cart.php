...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample07">
          ...
          <a href="../sellerSignUp.php"><button type="button" class="btn btn-lg btn-block btn-primary">QuiQy Faster Than You THINK <i class="fas fa-arrow-circle-right"></i></button></a>
          </form>
        </div>
      </div>
</nav>
            ...
            <tbody>
                ...
                <tr>
                   ...
                   <?php
					  ...
					  <td>
					  <h5> <span style="font-size:25px">৳</span> &nbsp;<?php echo end($gtotal); ?></h5>
					  </td>
					  <td>
