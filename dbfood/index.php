...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container">
    <a class="navbar-brand" href="index.php">QuiQy</a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarsExample07" aria-controls="navbarsExample07" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarsExample07">
            ...
            <form class="form-inline my-2 my-md-0">
              <a href="sellerSignUp.php"><button type="button" class="btn btn-lg btn-block btn-warning">QuiQy Faster Than You THINK <i class="fas fa-arrow-circle-right"></i></button></a>
            </form>
        </div>
  </div>
</nav>
  ...
  <main role="main">
    <div class="jumbotron" style="background: url(assets/images/bg-image1.jpg) no-repeat center / cover;">
      <div class="col-sm-8 mx-auto">
        <h1>Discover The Flavors Of QuiQy</h1>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-12">
          <div class="card mb-4 box-shadow">
            ...
            <div class="card-body">
              ...
              Cuisine: <?php echo $res['cuisines']; ?> 
              <br>
             <span style="font-size:25px">&#2547;</span> <b><?php echo $res['cost']; ?></b> per person</p>
